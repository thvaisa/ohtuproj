...
public class BookController {
    ...
    String editBook(@RequestBody MultiValueMap<String, String> formData, @PathVariable Long id) {
        ...
        if (book != null) {
            ...
            //Just some unnecessary refractoring
            if(bookName != null) book.setName(bookName.get(0));
            if(bookDate != null) book.setDate(bookDate.get(0));
            if(bookISBN != null) book.setISBN(bookISBN.get(0));
            if(bookAuthor != null) book.setAuthor(bookAuthor.get(0));
